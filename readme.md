...
At the edge of known space waits the **Beyond** — a region of warped spacetime, black holes, temporal anomalies, and impossible mathematics.
...
- Core religions and philosophical movements
- Important political and military figures
- Frontier regions and pirate activity
- Civilian life throughout the Core

---

# Design Philosophy

The Corepedia is intentionally written:
- **in-universe**
- from a partially institutional perspective
- with incomplete and sometimes contradictory historical knowledge

Many entries reference:
- fragmented records
- disputed accounts
...
The goal is to create the feeling of reading a real archival database from within a living civilization rather than an out-of-universe lore encyclopedia.

---

# Canon Timeline

The current state of the wiki represents the beginning of the modern storyline in the year **5016**.

Many major events, conflicts, discoveries, betrayals, and political crises referenced or foreshadowed within the archive have not yet occurred chronologically within the setting.

In many ways, the current timeline represents:
> *"Episode 1, Season 1"*  
of the broader Metal Mercs universe.
...
- late imperial historical periods
...
Most entries are written as standalone markdown (`.md`) documents intended for static wiki hosting.
